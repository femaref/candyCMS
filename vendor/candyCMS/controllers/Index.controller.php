...
use CandyCMS\Core\Helper\Dispatcher as Dispatcher;
...
require_once PATH_STANDARD . '/vendor/candyCMS/helpers/Dispatcher.helper.php';
...
class Index {
  ...
  public function __destruct() {
    ...
    \CandyCMS\Core\Model\Main::disconnectFromDatabase();
  }
   ...
   */
	public function getRoutes() {
		...
		if(!isset($this->_aSession['routes']) || WEBSITE_MODE == 'development' || WEBSITE_MODE == 'test') {
			...
			$this->_aSession['routes'] = sfYaml::load(file_get_contents(PATH_STANDARD . '/app/config/Routes.yml'));
		}
   ...
   */
    ...
    if (isset($this->_aRequest['api_token']) && !empty($this->_aRequest['api_token'])) {
      if (EXTENSION_CHECK && file_exists(PATH_STANDARD . '/app/ext/models/Users.model.php')) {
        ...
        $aUser = \CandyCMS\Core\Model\Users::getUserByToken(Helper::formatInput($this->_aRequest['api_token']));
      }
    }
    ...
    # Get user by session
      ...
      if (EXTENSION_CHECK && file_exists(PATH_STANDARD . '/app/ext/models/Sessions.model.php')) {
        ...
        $aUser = \CandyCMS\Core\Model\Sessions::getUserBySession();
      }
    }
  ...
  public function show() {
    ...
    # HTML with template
      ...
      $oSmarty->setCaching(\CandyCMS\Core\Helper\SmartySingleton::CACHING_OFF);
