...
use CandyCMS\Core\Plugin\Controller\Recaptcha as Recaptcha;
...
class Users extends Main {
  ...
  public function show() {
    ...
    switch ($this->_aRequest['action']) {
      ...
      case 'show':
        ...
        $this->oSmarty->setCaching(\CandyCMS\Core\Helper\SmartySingleton::CACHING_LIFETIME_SAVED);
        return $this->_show();
   ...
   * otherwise upload new Avatar, unset Gravatar on success and redirect to user Profile
    ...
    require PATH_STANDARD . '/vendor/candyCMS/helpers/Upload.helper.php';
