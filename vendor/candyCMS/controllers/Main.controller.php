...
abstract class Main {
  ...
  public static function __autoload($sClass, $bModel = false) {
    ...
    if ($bModel === true) {
      ...
      if (EXTENSION_CHECK && file_exists(PATH_STANDARD . '/app/ext/controllers/' . $sClass . '.controller.php')) {
        require_once PATH_STANDARD . '/app/ext/controllers/' . $sClass . '.controller.php';
        return '\CandyCMS\Controller\Extension_' . $sClass;
      }
      else {
        require_once PATH_STANDARD . '/vendor/candyCMS/controllers/' . $sClass . '.controller.php';
        return '\CandyCMS\Core\Controller\\' . $sClass;
      }
    }
  }
  ...
  public function __init() {
	 ...
	 * @see vendor/candyCMS/helpers/Dispatcher.helper.php
	 *
	 */
