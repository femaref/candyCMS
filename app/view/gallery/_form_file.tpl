...
<form action='{$action}' method='post' enctype='multipart/form-data' id='upload'>
	<table>
			...
			<td class='right'>
				...
				<div id="fancy-status" class="hide">
					...
					<div>
						...
						<img src="%PATH_PUBLIC%/lib/fancyupload/assets/progress-bar/bar.gif" class="progress overall-progress" />
					</div>
					<div>
						<strong class="current-title"></strong><br />
						<img src="%PATH_PUBLIC%/lib/fancyupload/assets/progress-bar/bar.gif" class="progress current-progress" />
					</div>
		...
		<tr class='row1'>
			...
			<td class='right'>
				<input type='text' class='inputtext' name='description' value='{$description}' />
			</td>
		</tr>

	</table>
	{if $smarty.get.action == 'updatefile'}
      <input type='submit' class='inputbutton' id='submit' value='{$lang_headline}' />
    ...
    {else}
      <input type='button' class='inputbutton' id='fancy-upload' value='{$lang_headline}' />
	{/if}
