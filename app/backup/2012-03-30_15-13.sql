...
# Database: cms_new
#
# Time of backup: 2012-03-30 15:13
#---------------------------------------------------------------#
...
`user_id` smallint(6) default NULL,
 PRIMARY KEY (`id`)
) AUTO_INCREMENT=1546 DEFAULT CHARSET=utf8;
...
`user_id` smallint(6) default NULL,
 PRIMARY KEY (`id`)
) AUTO_INCREMENT=1547 DEFAULT CHARSET=utf8;
...
`user_id` smallint(6) default NULL,
 PRIMARY KEY (`id`)
) AUTO_INCREMENT=1548 DEFAULT CHARSET=utf8;
