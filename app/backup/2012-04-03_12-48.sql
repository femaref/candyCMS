...
# Database: cms_new
#
# Time of backup: 2012-04-03 12:48
#---------------------------------------------------------------#
...
`user_id` smallint(6) default NULL,
 PRIMARY KEY (`id`)
) AUTO_INCREMENT=1528 DEFAULT CHARSET=utf8;
...
INSERT INTO `logs` VALUES ('1527','cronjob','execute','0','1333450110','1333450110','0');
...
`user_id` smallint(6) default NULL,
 PRIMARY KEY (`id`)
) AUTO_INCREMENT=1529 DEFAULT CHARSET=utf8;
...
INSERT INTO `logs` VALUES ('1528','cronjob','execute','0','1333450130','1333450130','0');
...
`user_id` smallint(6) default NULL,
 PRIMARY KEY (`id`)
) AUTO_INCREMENT=1530 DEFAULT CHARSET=utf8;
...
INSERT INTO `logs` VALUES ('1529','cronjob','execute','0','1333450136','1333450136','0');
