...
class SmartySingleton extends Smarty {
  ...
  public function __construct() {
    ...
    if($bUseFacebook === true) {
      $this->assign('PLUGIN_FACEBOOK_ADMIN_ID', PLUGIN_FACEBOOK_ADMIN_ID); # required for meta only
      $this->assign('PLUGIN_FACEBOOK_APP_ID', PLUGIN_FACEBOOK_APP_ID); # required for facebook actions
    }
    ...
    $this->assign('_SYSTEM', array("date" => date('Y-m-d'),
